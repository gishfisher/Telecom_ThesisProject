...
public class MountingPointAddEditViewModel : ObservableObject
{
    ...
    public int? MountingPointId { get; }
    ...
    public MountingPointAddEditViewModel(int addressId, MountingPoint? mp)
    {
        ...
        if (IsEdit && mp != null)
        {
            SelectedPointTypeId = mp.PointTypeId;
    ...
    private void Save()
    {
        ...
        try
        {
            if (IsEdit && MountingPointId.HasValue)
            {
                var mp = new MountingPoint
                {
                    Id = MountingPointId.Value,
                    AddressId = AddressId,
                    PointTypeId = SelectedPointTypeId,
                    LocationDescription = LocationDescription?.Trim()
                };
                _addressService.EditMountingPoint(mp);
            }
            else
            {
                var mp = new MountingPoint
